...
class Plugin_Name_Admin {
	...
	public static function new_cpt_rdv() {
		...
		$opts['labels']['add_new']						= esc_html__( "Add New {$single}", 'medical-calendar' );
		$opts['labels']['add_new_item']					= esc_html__( "Add New {$single}", 'medical-calendar' );
		$opts['labels']['all_items']					= esc_html__( $plural, 'medical-calendar' );
		$opts['labels']['edit_item']					= esc_html__( "Edit {$single}" , 'medical-calendar' );
		...
		$opts['labels']['new_item']						= esc_html__( "New {$single}", 'medical-calendar' );
		$opts['labels']['not_found']					= esc_html__( "No {$plural} Found", 'medical-calendar' );
		$opts['labels']['not_found_in_trash']			= esc_html__( "No {$plural} Found in Trash", 'medical-calendar' );
		$opts['labels']['parent_item_colon']			= esc_html__( "Parent {$plural} :", 'medical-calendar' );
		$opts['labels']['search_items']					= esc_html__( "Search {$plural}", 'medical-calendar' );
		$opts['labels']['singular_name']				= esc_html__( $single, 'medical-calendar' );
		$opts['labels']['view_item']					= esc_html__( "View {$single}", 'medical-calendar' );
